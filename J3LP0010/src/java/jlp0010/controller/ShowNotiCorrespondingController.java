 ...
 * @author DELL
 */
public class ShowNotiCorrespondingController extends HttpServlet {

    private static final Logger LOG = Logger.getLogger(ShowNotiCorrespondingController.class);
     ...
     */
    private final String DETAIL = "ShowArticleDetailController";
